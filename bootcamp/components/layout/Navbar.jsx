  ...
  const Navbar = () => {
    ...
    return (
      <>
        <nav
          className={`w-full h-[104px] px-4 sm:px-6 md:px-24 fixed top-[18px] left-0 right-0 z-40 flex items-center justify-center transition-all duration-300 ${
        ...
        >
          <div className="w-full max-w-[1248px] h-full flex items-center justify-between relative">
            ...
            {/* Desktop Links */}
            <div className="hidden md:flex items-center gap-6 bg-[#F0F2F5] px-16 py-4 rounded-full overflow-x-auto scrollbar-hide">
              {NAV_LINKS.map((link) => (
