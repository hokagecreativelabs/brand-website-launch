...
const Hero = () => {
  ...
  return (
    <section
      className="h-[1200px] md:h-auto pt-10 md:pt-12 relative w-full flex flex-col items-center justify-center overflow-hidden bg-[url('/images/bg-pattern.webp')] bg-cover bg-center"
